          ...
          <div class="row row-cols-1 row-cols-md-4 ">
            <div class="card mx-auto">
              <div class="col">
                ...
                <img class="bd-placeholder-img card-img-top" width="50%" height="425" src="data:image/jpeg;base64,<?php echo $livros[0]['capa']; ?>" alt="Capa do livro">
                <div class="card-body">
                    <p class="card-text"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $livros[0]['titulo']?></font></p>
                  </div>
                </div>
              </div>
            </div>
            <div class="card mx-auto">
              <div class="col">
                <div class="card shadow-sm">
                  <img class="bd-placeholder-img card-img-top" width="50%" height="425" src="data:image/jpeg;base64,<?php echo $livros[1]['capa']; ?>" alt="Capa do livro">
                  <div class="card-body">
                    <p class="card-text"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $livros[1]['titulo']?></font></p>
                   </div>
                </div>
              </div>
            </div>
            <div class="card mx-auto">
              <div class="col">
                <div class="card shadow-sm">
                  <img class="bd-placeholder-img card-img-top" width="50%" height="425" src="data:image/jpeg;base64,<?php echo $livros[2]['capa']; ?>" alt="Capa do livro">
                  <div class="card-body">
                    <p class="card-text"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $livros[2]['titulo']?></font></p>
                   </div>
                </div>
              </div>
            </div>
